...
public class PriorityMap<E, K, P>
{
    ...
    /**
     * Add an entity to the priority map. If the key for the {@code entity} was
     * already found in the priority map and the priority is the same the entity
     * will be added. If the priority is lower the existing entities for that
     ...
     *         priority map. Will return {@code false} iff the key for the
     *         entity already exist and its priority is better than the given
     *         {@code priority}.
     */
