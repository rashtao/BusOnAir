...
#export NEO4J_HOME=/home/rashta/neo4j/transportaquila
export NEO4J_HOME=/tmp/neo4j/busonairserver
...
echo "org.neo4j.server.thirdparty.delete.key=secret-key" >>  $NEO4J_HOME/conf/neo4j-server.properties
